...
class BaseTrainer:
    ...
    Attributes:
        ...
        epochs (int): Number of epochs to train2 for.
    ...
    def train(self):
        ...
        # Run subprocess if DDP training, else train2 normally
    ...
    def _do_train(self, rank=-1, world_size=1):
        ...
        self.log(f"Image sizes {self.args.imgsz} train2, {self.args.imgsz} val\n"
    ...
    def get_dataset(self, data):
        """
        Get train2, val path from data dict if it exists. Returns None if data format is not recognized.
        """
    ...
    def get_dataloader(self, dataset_path, batch_size=16, rank=0, mode="train", augment=True):
        """
    ...
    def label_loss_items(self, loss_items=None, prefix="train2"):
        """
        ...
        if resume:
            try:
                ...
                raise FileNotFoundError("Resume checkpoint not found. Please pass a valid checkpoint to resume from, "
                                        "i.e. 'yolo train2 resume model=path/to/last.pt'") from e
        self.resume = resume
    ...
    def resume_training(self, ckpt):
        ...
        if self.resume:
            assert start_epoch > 0, \
                ...
                f"Start a new training without --resume, i.e. 'yolo task=... mode=train2 model={self.args.model}'"
            LOGGER.info(
