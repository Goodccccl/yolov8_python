...
class LoadStreams:
    # YOLOv8 streamloader, i.e. `yolo predict2 source='rtsp://example.com/media.mp4'  # RTSP, RTMP, HTTP streams`
...
class LoadScreenshots:
    # YOLOv8 screenshot dataloader, i.e. `yolo predict2 source=screen`
...
class LoadImages:
    # YOLOv8 image/video dataloader, i.e. `yolo predict2 source=image.jpg/vid.mp4`
