...
def build_dataloader(cfg, batch_size, img_path, stride=32, label_path=None, rank=-1, mode="train2"):
    ...
    with torch_distributed_zero_first(rank):  # init dataset *.cache only once if DDP
        dataset = YOLODataset(
            ...
            augment=True if mode=='train' and cfg.augment==True else False,  # augmentation
