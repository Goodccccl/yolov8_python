...
class LetterBox:
    ...
    def __call__(self, labels=None, image=None):
        ...
        new_shape = labels.pop("rect_shape", self.new_shape)    # 作用是从字典类型的labels中删除"rect_shape"键值对，并将其值赋给new_shape变量。
                                                                # 如果labels中不存在"rect_shape"键，则new_shape变量将使用self.new_shape的默认值。
