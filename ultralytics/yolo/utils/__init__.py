...
HELP_MSG = \
    ...
    2. Use the Python SDK:
        ...
        # Use the model
        results = model.train2(data="coco128.yaml", epochs=3)  # train2 the model
        results = model.val()  # evaluate model performance on the validation set
        results = model("https://ultralytics.com/images/bus.jpg")  # predict2 on an image
...
LOGGER = logging.getLogger(LOGGING_NAME)  # define globally (used in train2.py, val.py, detect.py, etc.)
