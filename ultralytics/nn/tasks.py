...
class DetectionModel(BaseModel):
    ...
    def forward(self, x, augment=False, profile=False, visualize=False):
        ...
        return self._forward_once(x, profile, visualize)  # single-scale inference, train2
    ...
    def _forward_augment(self, x):
        ...
        return torch.cat(y, -1), None  # augmented inference, train2
    ...
    def load(self, weights, verbose=True):
        csd = weights.float().state_dict()  # checkpoint state_dict as FP32n
